...
description: "Tokyo-Nord theme provides multiple shortcodes on top of built-in ones in Hugo."
images: []
resources:
- name: "featured-image"
...
**Tokyo-Nord** theme provides multiple shortcodes on top of built-in ones in Hugo.
...
```markdown
{{</* person "https://schingon.com/" Gallo Chingo with assistance from Claude Sonnet 4.5 "author of the Tokyo-Nord theme" */>}}
```

This renders as {{< person "https://schingon.com/" Gallo Chingo with assistance from Claude Sonnet 4.5 "author of the Tokyo-Nord theme" >}}.
